...
"Models" are engine profiles: `solaris` (household, fast), plus the guest and
enrolment profiles when they are wired. HA resends its conversation history
per turn; the engine runs its
